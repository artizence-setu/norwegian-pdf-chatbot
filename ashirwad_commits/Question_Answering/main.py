...
def create_assistant(file):
    assistant = client.beta.assistants.create(
        name="PDF Guru",
        instructions="You are an assistant. You will be given some text data and you have to answer user questions based on that text data only. Do not include any other information outside of this text data.",
        temperature=0.2,
        tools=[{'file_search'}],
        model="gpt-4-1106-preview",
        tool_resources=[file.id]
    )
    return assistant
...
def main():
    ...
    while temp == True:
        ...
        new_message = generate_response(user_question)
        print("*"*20)
